...
const HEADER = `<div align="center">
  <img src="https://raw.githubusercontent.com/${process.env.GITHUB_REPOSITORY}/refs/heads/${process.env.GITHUB_HEAD_REF}/.github/actions/code-review/azion-ai-logo.webp" alt="Azion AI Logo" width="150" height="150">
</div>\n\n`;
